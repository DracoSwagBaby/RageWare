...
NotificationLibrary:SendNotification("Warning", "RageWare Loading...", 2) --2
wait(3) --3
NotificationLibrary:SendNotification("Warning", "UI Loading...", 2) --2
wait(3) --3
NotificationLibrary:SendNotification("Warning", "Bypasses Loading...", 2) --2
wait(3) --3
NotificationLibrary:SendNotification("Success", "RageWare Loaded Have Fun", 5) --5
...
local Game_Name = (game.PlaceId == 100 and "Town") or (game.PlaceId == 100 and "The Bronx") or (game.PlaceId == 100 and "The Bronx") or (game.PlaceId == 100 and "South Bronx") or (game.PlaceId == 100 and "South Bronx") or (game.PlaceId == 100 and "South Bronx") or (game.PlaceId == 100 and "BlockSpin") or (game.PlaceId == 100 and "Street Life") or "Universal" or game.PlaceId == 13643807539
...
-- // IMAGES [MAIN IMPORTANT] \\ --

local Images = {"Targets2.png", "Lines.png", "Circle.png", "Aimbot.png", "Star.png", "Main.png", "ESP.png", "World.png", "Wrench.png", "Settings.png", "Node.png", "cursor.png", "Bullet.png", "Snapline.png", "Pistol.png", "Silent.png", "folder.png", "UZI.png", "FieldOfView2.png", "Lock.png", "Aimlock.png", "Cash.png", "Wheatt.png", "Pickkaxe.png", "unlocked.png"}





-- // IMAGES ALREADY INSIDE [CHANGED] \\ --
...
for Index, Value in Images do
    ...
    if not isfile(Location) then
        local ImageDiddyAhhBlud = game:HttpGet("https://raw.githubusercontent.com/DracoSwagBaby/imagessynex/main/"..Value)
    ...
    -- Library element functions
        function library:window(properties)
            ...
            local items = cfg.items; do
                ...
                local time_left = tostring((LRM_SecondsLeft < math.huge and ""..tostring(math.floor(((LRM_SecondsLeft / 60) / 60) / 24)).." days" or LRM_SecondsLeft == math.huge and "Secured by RageWare™"))
        ...
        function library:init_config(window) 
            ...
            local column = main:column({})
            local section = column:section({name = "Settings", side = "right", size = 1, default = false, icon = GetImage("Lines.png")})
            ...
            section:keybind({name = "Menu Bind", key = Enum.KeyCode.Delete, callback = function(bool) window.toggle_menu(bool) end, seperator = true, default = true})
...
local function get_cheat_type()
    return "Cheat Type: Universal"
end
...
local window = library:window({
    name = "Rage", 
    suffix = "Ware™", 
    gameInfo = "Executor: " .. executor .. " | " .. get_cheat_type()  -- Display the executor name and cheat type here
})
    ...
    window:seperator({name = "Game"}) do
        local LocalPlayerTab, PlayersTab, PurchaseGunTab, MiscTab, SafeTab = window:tab({name = "Main", tabs = {"Local Player", "Players", "Teleports", "Misc", "Safe"}, icon = GetImage("World.png")}) do
            ...
            do -- \\ Local Player Tab
                ...
                local UISection = LocalPlayerColumn:section({name = "Toggle Interfaces Section", side = "right", size = 0.225, icon = GetImage("Lines.png")})
            ...
            do -- \\ Misc Tab
                ...
                local FarmSettingsSection = Column:section({name = "Farming Settings", size = 0.225, default = false, side = 'left', Icon = GetImage("Lines.png")}) 
    ...
    window:seperator({name = "Game"}) do
        local LocalPlayerTab, PlayersTab, PurchaseGunTab = window:tab({name = "Main", tabs = {"Local Player", "Players", "Teleports"}, icon = GetImage("World.png")}) do
            do -- \\ Local Player
                ...
                LocalPlayerModsSection = LocalPlayerColumn:section({name = "Modification Settings", side = "left", size = 0.275, icon = GetImage("Lines.png")})
...
window:seperator({name = "Combat"}) do
    local SilentAimTab = window:tab({name = "Silent", tabs = {"Main"}, icon = GetImage("Silent.png")}) do
        local SilentAimColumn = SilentAimTab:column({})

        local GeneralSection = SilentAimColumn:section({name = "General", side = "left", size = 0.23, icon = GetImage("Main.png")})
        ...
        local SettingsSection = SilentAimColumn:section({name = "Settings", side = "left", size = 0.455, icon = GetImage("Lines.png")})
        ...
        local BulletSettingsSection = SilentAimColumn:section({name = "Wall Shooting", side = "left", size = 0.18, icon = GetImage("Star.png")})
        
        BulletSettingsSection:toggle({type = "toggle", name = "Shoot Through Walls", flag = "SilentAim_WallBang", default = false, callback = function(state)
            Config.Silent.WallBang = state
        end})

        SilentAimColumn = SilentAimTab:column({})

        local FieldOfViewSection = SilentAimColumn:section({name = "FOV", side = "right", size = 0.23, icon = GetImage("Circle.png")})
        ...
        local FieldOfViewSettingsSection = SilentAimColumn:section({name = "FOV Settings", side = "right", size = 0.3, icon = GetImage("Lines.png")})
        ...
        local SnaplineSection = SilentAimColumn:section({name = "Target", side = "right", size = 0.275, icon = GetImage("Targets2.png")})
    ...
    local AimlockTab = window:tab({name = "Aimbot", tabs = {"Main"}, icon = GetImage("Aimbot.png")}) do
        local AimlockAimColumn = AimlockTab:column({})

        local GeneralSection = AimlockAimColumn:section({name = "General", side = "left", size = 0.23, icon = GetImage("Main.png")})
        ...
        local SettingsSection = AimlockAimColumn:section({name = "Settings", side = "left", size = 0.51, icon = GetImage("Lines.png")})
        ...
        local FieldOfViewSection = AimlockAimColumn:section({name = "FOV", side = "right", size = 0.23, icon = GetImage("Circle.png")})
        ...
        local FieldOfViewSettingsSection = AimlockAimColumn:section({name = "FOV Settings", side = "right", size = 0.3, icon = GetImage("Lines.png")})
        ...
        local SnaplineSection = AimlockAimColumn:section({name = "Target", side = "right", size = 0.275, icon = GetImage("Targets2.png")})
    ...
    if Game_Name == "The Bronx" and not Solara then
        local WeaponModTab, MiscModTab = window:tab({name = "Modifications", tabs = {"Weapon Modifications", "Hitbox Modifications"}, icon = GetImage("Wrench.png")}) do
            local WeaponModTabColumn = WeaponModTab:column({}) do
                ...
                GeneralSection = WeaponModTabColumn:section({name = "Weapon Modifications", side = "left", size = 0.5, icon = GetImage("Lines.png")})
...
window:seperator({name = "Visual"}) do
    local VisualsTab = window:tab({name = "ESP", tabs = {"Players"}, icon = GetImage("ESP.png")})

    local VisualsColum = VisualsTab:column({})
    local PlayerVisualsSection = VisualsColum:section({name = "ESP", side = "left", size = 0.7, icon = GetImage("Main.png")}) -- HERE@$215#!**&)_tvasc2_21a!@&!$sdc
    ...
    local _FilledBoxes = PlayerVisualsSection:toggle({name = "Filled Boxe", flag = "PlayerVisuals_FilledBoxes", type = "toggle", callback = function(state)
        Config.ESP.Drawing.Boxes.Filled.Enabled = state
        RefreshAllElements()
    end})

    _FilledBoxes:colorpicker({flag = "PlayerVisuals_FilledBoxes_Color1", color = Color3.fromRGB(255, 0, 0), alpha = 0.25, callback = function(state, alpha)
    ...
    local HealthBar_Toggle = PlayerVisualsSection:toggle({name = "Health Bar", flag = "PlayerVisuals_HealthBars", type = "toggle", callback = function(state)
    ...
    local _ChamsToggle = PlayerVisualsSection:toggle({name = "Outline Chams", flag = "PlayerVisuals_Chams", type = "toggle", callback = function(state)
        Config.ESP.Drawing.Chams.Enabled = state
        RefreshAllElements()
    end})

    _ChamsToggle:colorpicker({flag = "PlayerVisuals_Chams_Color1", color = Color3.fromRGB(255, 0, 0), alpha = 0.8, callback = function(state, alpha)
    ...
    local PlayerVisualsSettingsSection = VisualsColum:section({name = "ESP Settings", side = "left", size = 0.7, icon = GetImage("Lines.png")})
    ...
    PlayerVisualsSettingsSection:toggle({name = "Dynamic Health Text", flag = "Visuals_HealthTextLerp", default = false, type = "toggle", callback = function(state)
        Config.ESP.Drawing.Healthbar.Lerp = state
        RefreshAllElements()
    end})

    PlayerVisualsSettingsSection:toggle({name = "Better Health Bar", flag = "Visuals_HealthBarGradient", default = false, type = "toggle", callback = function(state)
        Config.ESP.Drawing.Healthbar.Gradient = state
        RefreshAllElements()
    end})

    PlayerVisualsSettingsSection:toggle({name = "Better Chams", flag = "Visuals_ChamsThermal", default = false, type = "toggle", seperator = true, callback = function(state)
        Config.ESP.Drawing.Chams.Thermal = state
        RefreshAllElements()
    end})
    

    PlayerVisualsSettingsSection:dropdown({name = "Fonts", flag = "Visuals_TextFont", width = 130,
        items = {
            "Arcade",
            "BuilderSans",
            "Code",
